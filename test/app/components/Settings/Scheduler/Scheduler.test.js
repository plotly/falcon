...
import Scheduler, { MetaPreviewModal, SQL } from '../../../../../app/components/Settings/Scheduler.react.js';
import Modal from '../../../../../app/components/Modal.react.js';
...
describe('Scheduler Test', () => {
 ...
 it('should have no rows if not passed any queries', () => {
  ...
  it('should open and close modal with correct query', () => {
    ...
    expect(component.find(MetaPreviewModal).find(SQL).text()).toBe('SELECT * FROM foods;');
