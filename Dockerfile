...
# $ docker run -p 9494:9494 -d chriddyp/database-connector -v ~/.plotly/connector:/plotly-connector
#
...
# Set the API domain of the plot.ly server
ENV PLOTLY_CONNECTOR_PLOTLY_API_DOMAIN=$PLOTLY_DOMAIN_API
ENV PLOTLY_CONNECTOR_PLOTLY_API_SSL_ENABLED=$PLOTLY_STREAMBED_SSL_ENABLED
